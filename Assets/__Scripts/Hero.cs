...
public class Hero : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Use the fireEvent to fire Weapons when teh Spacebare is pressed
    ...
    public void AbsorbPowerUp( PowerUp pUp ) {
        ...
        switch ( pUp.type ) {
            ...
            default:
                ...
                else {      //If it is a different weapon type
                    ClearWeapons();
    ...
    public float shieldLevel {
        ...
        private set {
            ...
            //If the shield is going t obe set to less than zero
            if( value < 0 ) {
